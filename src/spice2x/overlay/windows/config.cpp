...
namespace overlay::windows {
    ...
    const auto PROJECT_URL = "https://savemga.com";
    ...
    Config::Config(overlay::SpiceOverlay *overlay) : Window(overlay) {
        ...
        this->games_selected = 8;
        this->games_selected_name = "Metal Gear";
    ...
    void Config::build_buttons(const std::string &name, std::vector<Button> *buttons, int min, int max) {
        ...
        if (buttons) {
            ...
            for (int button_it = min; button_it <= button_it_max; button_it++) {
                ...
                std::string bind_name = "" + button_name;
                if (ImGui::Button("")
                ...
                // naive binding
                ImGui::SameLine();
                std::string naive_string = "Bind " + button_name;
    ...
    void Config::build_about() {
        ImGui::TextUnformatted(std::string(
            "spiceMGA (a custom build of Spice2x)\r\n"
            "=========================\r\n" +
            to_string("0.02")).c_str());
